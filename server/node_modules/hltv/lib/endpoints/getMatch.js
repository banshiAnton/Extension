            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    vetoes = team1 && team2 && mappers_1.toArray($('.veto-box').last().find('.padding > div'))
                        .slice(0, -1).map(function (el) { return mappers_1.mapVetoElementToModel(el, team1, team2); });
                    event = {
                    ...
                    headToHead = team1 && team2 && mappers_1.toArray($('.head-to-head-listing tr')).map(function (matchEl) { return ({
